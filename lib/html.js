    ...
    if (inputObject.lineRoutines) {
        for (var i in inputObject.lineRoutines) {
            if (inputObject.lineRoutines[i].mRoutine || inputObject.lineRoutines[i].mRoutine === "") {
                ...
                //If data has metadata, overwrite leading RTN tag with popover content.
                if (inputObject.lineRoutines[i].mRoutineMarkup) {
                    var tmpMarkup = inputObject.lineRoutines[i].mRoutineMarkup;
                    leadingRtnTag = "<a class=\"mRoutine\" data-toggle=\"popover\" data-placement=\"top\" data-html=\"true\" data-trigger=\"hover\" title=\"" + tmpMarkup.routineName + "\" data-content=\"<pre>" + tmpMarkup.routineSyntax + "</pre>" + tmpMarkup.routineDesc + "\">";
                }
